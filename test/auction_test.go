...
func TestCreateEnglishAuction(t *testing.T) {
	...
	assert.Equal(t, uint64(1000), auction.StartPrice)
...
func TestEnglishAuctionBidding(t *testing.T) {
	...
	assert.Equal(t, uint64(1500), auction.HighBid)
}
...
func TestCreateDutchAuction(t *testing.T) {
	...
	assert.Equal(t, uint64(10000), auction.StartPrice)
	assert.Equal(t, uint64(1000), auction.EndPrice)
}
