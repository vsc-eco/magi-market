// Minimal SDK for the DEX mock. This package is ONLY ever compiled by tinygo
// for the test harness (never host-compiled), so there is no host-stub split.
// The //go:wasmimport decls below are always linked.
//
